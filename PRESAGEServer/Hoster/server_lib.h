...
#define ENCLAVE_FILE _T("DeezEnclave.signed.dll") 
...
//int InitEnclave(ServerContext *context);//by wwj
//int InitServerContextAfterConfig(ServerContext *context);//by wwj
int WaitForClients(ServerContext *context);
int ReceiveDataFromClient(ServerContext *serverCtx);
//int ProcessandSendResults(ServerContext *serverCtx);//by wwj